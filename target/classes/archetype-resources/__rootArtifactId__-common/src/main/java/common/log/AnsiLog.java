...
public abstract class AnsiLog {
    ...
    private static final String RESET = "${symbol_escape}033[0m";
    ...
    static {
        ...
        if (OSUtils.isCygwinOrMinGW() || OSUtils.isMac()) {
            enableColor = true;
        }
    }
    ...
    private static String colorStr(String msg, int colorCode) {
        return "${symbol_escape}033[" + colorCode + "m" + msg + RESET;
    }
        ...
        if (from != null) {
            ...
            if (arguments != null && arguments.length != 0) {
                for (Object argument : arguments) {
                    ...
                    computed = computed.replaceFirst("${symbol_escape}${symbol_escape}{${symbol_escape}${symbol_escape}}", Matcher.quoteReplacement(argument.toString()));
                }
            }
            return computed;
        }
